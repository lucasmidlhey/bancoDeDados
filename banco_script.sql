...
CREATE TABLE IF NOT EXISTS `mydb`.`Cidade` (
  `id_cidade` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT ' Valor único identificador de uma cidade. \n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Bairro` (
  `id_bairro` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Valor único identificador de um bairro.',
  `nome_bairro` VARCHAR(45) NOT NULL COMMENT 'Nome completo do bairro.',
...
CREATE TABLE IF NOT EXISTS `mydb`.`TipoLogradouro` (
  `id_tipo_logradouro` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Valor único do identificador de um tipo de logradouro. \n',
  `descricao_tipo_logradouro` VARCHAR(45) NOT NULL COMMENT 'Descreve o tipo do Logradouro. Ex: praça, rua, avenida.',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Logradouro` (
  `id_logradouro` INT NOT NULL AUTO_INCREMENT COMMENT 'Valor único identificador de um Logradouro.',
  `descricao_logradouro` VARCHAR(45) NOT NULL COMMENT 'Nome do Logradouro. Ex: Quinta Avenida, Rua das Flores etc. ',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Endereco` (
  `id_endereco` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT ' Valor único identificador de um endereço.\n',
  `complemento` VARCHAR(45) NOT NULL COMMENT ' Descreve um complemento algo próximo ao endereço. \nEx: Próximo ao terminal rodoviário. \n',
  `numero` INT NOT NULL COMMENT ' Número da residência do cidadão\n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Buraco` (
  `id_buraco` INT NOT NULL AUTO_INCREMENT COMMENT ' Valor único identificador de um buraco.\n',
  ...
  `descricao_buraco` VARCHAR(45) NOT NULL COMMENT 'Descreve a localização do buraco. Ex: na calçada, meio da rua, canteiro etc.',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Naturalidade` (
  `id_naturalidade` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT ' \nValor único do identificador de um material de enchimento.\n',
  `descricao_naturalidade` VARCHAR(45) NOT NULL COMMENT ' Representa o nome da localidade/Cidade onde o indivíduo nasceu. \nExemplo: Rio de Janeiro\n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`TipoDano` (
  `id_tipo_dano` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Chave única que identifica o tipo do dano.',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Cidadao` (
  `id_cidadao` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT ' Valor único identificador de um cidadão.\n\n',
  ...
  `nome_pai_cidadao` VARCHAR(45) NOT NULL COMMENT ' Representa o nome completo por extenso de um indivíduo pai de um cidadão \nEx: Joao Maria das Neves.\n',
  `nome_mae_cidadao` VARCHAR(45) NOT NULL COMMENT ' Representa o nome completo por extenso de um indivíduo mãe de um cidadão \nEx: Maria das Neves.\n',
  `sexo_cidadao` CHAR(1) NOT NULL COMMENT ' Caractere que representa o sexo de um cidadão (M) Masculino e (F) Feminino.\n',
  `estado_civil_cidadao` VARCHAR(45) NOT NULL COMMENT ' Representa o estado civil do cidadão como \nSolteiro(a), Casado(a), Divorciado(a), Viúvo(a), Separado(a).\n',
  `email_cidadao` VARCHAR(45) NOT NULL COMMENT ' Nome da conta de email ativa do cidadão.\n',
  ...
  `escolaridade_cidadao` VARCHAR(45) NOT NULL COMMENT ' Representa o nível de ensino do cidadão: Fundamental Completo, \nEnsino Médio Completo, Ensino Técnico Completo, Ensino Superior Completo.\n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Departamento` (
  `id_departamento` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'Chave única que identifica o Departamento.',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Telefone` (
  `id_telefone` INT NOT NULL AUTO_INCREMENT COMMENT ' Valor único do identificador de um número de telefone.\n',
  `descricao_telefone` VARCHAR(45) NOT NULL COMMENT ' Número de telefone.\n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`EquipeReparo` (
  `id_equipe_reparo` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT ' Valor único do identificador de uma equipe de reparo. \n',
  `numero_de_pessoas` INT NOT NULL COMMENT ' Representa a quantidade de pessoas em uma equipe de reparo.\n',
  `custo_hora` DOUBLE NOT NULL COMMENT 'Valor do custo por hora da equipe de reparo.',
...
CREATE TABLE IF NOT EXISTS `mydb`.`TipoMaterialEnchimento` (
  `id_tipo_material_enchimento` INT NOT NULL AUTO_INCREMENT COMMENT ' \nValor único do identificador de um tipo de material de enchimento. \n',
  `descricao_tipo_material_enchimento` VARCHAR(45) NOT NULL COMMENT ' \nDescrição do tipo de material de enchimento. Ex: Brita.\n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`OrdemTrabalho` (
  `id_ordem_trabalho` INT NOT NULL AUTO_INCREMENT COMMENT ' \nValor único do identificador de uma ordem de trabalho.\n',
  `status_reparo` VARCHAR(45) NOT NULL COMMENT ' \nRepresenta o status do reparo: Em andamento, realizado ou cancelado.  \n',
  `horas_de_trabalho` VARCHAR(45) NOT NULL COMMENT ' \nTempo gasto para realização do reparo de um buraco.   \n',
  `quantidade_material_enchimento` INT NOT NULL COMMENT 'Descreve a quantidade de material de enchimento utilizado no reparo.',
  `custo_reparo` DOUBLE NOT NULL COMMENT 'É calculado a partir da quantidade de horas_de_trabalho, \nquantidade_material_enchimento.',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Cargo` (
  `id_cargo` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT ' Valor único identificador de um cargo.\n',
  `descricao_cargo` VARCHAR(45) NOT NULL COMMENT 'Representa o nome do cargo. Ex: Mestre de obras.\n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Funcionario` (
  ...
  `nome_pai_funcionario` VARCHAR(45) NOT NULL COMMENT 'Representa o nome completo por extenso de um indivíduo pai de um funcionário. Ex: Joao Maria das Neves.',
  `nome_mae_funcionario` VARCHAR(45) NOT NULL COMMENT ' Representa o nome completo por extenso de um indivíduo mãe de um cidadão.\nEx: Maria das Neves Souza.\n',
  `sexo_funcionario` VARCHAR(45) NOT NULL COMMENT ' \nCaractere que representa o sexo de um funcionário (M) Masculino e (F) Feminino.\n',
  `estado_civil_funcionario` VARCHAR(45) NOT NULL COMMENT ' Representa o estado civil do funcionário como Solteiro(a), Casado(a), \nDivorciado(a), Viúvo(a), Separado(a).\n',
  ...
  `escolaridade_funcionario` VARCHAR(45) NOT NULL COMMENT ' Representa o nível de ensino do funcionário: Fundamental Completo, \nEnsino Médio Completo, Ensino Técnico Completo, Ensino Superior Completo\n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`TipoEquipamento` (
  `id_tipo_equipamento` INT NOT NULL AUTO_INCREMENT COMMENT ' \nValor único do identificador de um tipo de equipamento.\n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Fornecedor` (
  `id_fornecedor` INT NOT NULL AUTO_INCREMENT COMMENT ' Valor único do identificador de uma equipe de reparo. \n',
  `nome_fornecedor` VARCHAR(45) NOT NULL COMMENT ' Descreve o nome do fornecedor. Ex: Empresa X\n',
  `descricao_fornecedor` VARCHAR(45) NOT NULL COMMENT 'Descreve o que o fornecedor fornece por exemplo.\n Ex: Fornece cimentos do tipo X etc.',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Equipamento` (
  `id_equipamento` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT ' Valor único identificador de um equipamento. \n',
  `nome_equipamento` VARCHAR(45) NOT NULL COMMENT ' Descreve o nome do equipamento. Ex: Carrinho de mão.\n',
  `preco_equipamento` VARCHAR(45) NOT NULL COMMENT 'Descreve o preço do equipamento.\n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`TipoIndenizacao` (
  `id_tipo_indenizacao` INT NOT NULL AUTO_INCREMENT COMMENT ' \nValor único do identificador de um tipo de indenização.\n',
...
CREATE TABLE IF NOT EXISTS `mydb`.`Indenizacao` (
  `id_indenizacao` INT UNSIGNED NOT NULL AUTO_INCREMENT COMMENT ' \nValor único do identificador de um idenização. \n',
  `status_indenizacao` VARCHAR(45) NOT NULL COMMENT ' Representa o status da indenização:  Indenização Paga, Indenização atrasada, \nIndenização em processo, Indenização cancelada. \n',
  `valor_indenizacao` DOUBLE NOT NULL COMMENT 'Identifica o valor da Indenização. Ex: 550,35',
